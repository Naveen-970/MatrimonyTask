package com.example.matrimonytask.view.ui
...
class CarouselView (
        ...
        private val activeColor by lazy { ContextCompat.getColor(context, R.color.home_screen_top_bg) }
        private val inactiveColor by lazy { ContextCompat.getColor(context, R.color.gesture_screen_bottom_right) }
